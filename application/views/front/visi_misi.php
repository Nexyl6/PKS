                    ...
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="<?php echo base_url('pks/lihat_visimisi') ?>"><strong>Visi Misi</strong></a></li>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="blog" style="color: black;">
                    ...
                    <div class="blog-item well text-center">
                        <h2 style="color: #FF8551;">Visi</h2>
                    ...
                    <div class="blog-item well text-center">
                        <h2 style="color: #FF8551;">Misi</h2>
                        <ul class="faq">
                            <?php
                            $counter = 1;
                            foreach ($data as $key) {
                                $misiParagraphs = explode("\n", $key->misi); // Assuming each mission is on a new line
                                foreach ($misiParagraphs as $paragraph) {
                                    echo '<li>';
                                    echo '<span class="number">' . $counter . '</span>';
                                    echo '<div class="text-left">';
                                    echo '<h5 style="text-align: justify;">' . nl2br($paragraph) . '</h5>';
                                    echo '</div>';
                                    echo '</li>';
                                    $counter++;
                                }
