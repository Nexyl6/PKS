            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                        ...
                        <li class="active"><a href="<?php echo base_url('admin/pks/lihat_sejarah') ?>">SEJARAH</a></li>
                        <li class="dropdown">
            ...
            <div class="span12">
                <div class="blog" style="color: black;">
                    ...
                    <div class="blog-item well text-center">
                        <h2 style="color: #FF8551;">Sejarah</h2>
                        <div class="text-left">
                            <h5 style="text-align: justify;">
                                <?php
                                foreach ($data as $key) {
                                    echo nl2br($key->sejarah);
                                }
                                ?>
                            </h5>
                        </div>
